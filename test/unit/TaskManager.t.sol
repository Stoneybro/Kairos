...
contract TaskManagerTest is Test {
    ...
    function test_MultipleTasksWithDifferentDeadlines() public {
        ...
        vm.prank(address(account));
        (uint256 taskId2,) = taskManager.createTask("Task 2", REWARD_AMOUNT, 2 days, 1, 1 days);
        
        vm.prank(address(account));
        (uint256 taskId3,) = taskManager.createTask("Task 3", REWARD_AMOUNT, 3 days, 1, 1 days);
